/*  Free Template by www.heihachi.com  */

/*
Dragonfruit Template
http://www.heihachi.com/preview/heihachi_411_dragonfruit
*/
...
jQuery(function(){
    ...
    //main menu
    $("#heihachi_banner_menu ul").singlePageNav({offset: $('#heihachi_banner_menu').outerHeight()});
    //banner slide
    ...
    $(window).on("load scroll resize", function(){
        ...
        $("#heihachi_banner_slide > ul > li").css({"background-size":"cover"});
    });
    //about icon
    $(window).on("load scroll resize", function(){
        ...
        $("#heihachi_about .about_icon .imgwap i").css({
	...
	*/
    ...
    $(window).on("load resize", function(){
        ...
        $(".time_line_wap").each(function(){
            ...
            if($(window).width()<970){
                $("#heihachi_timeline .container-fluid").css({"position":"absolute"});
                positon_left = $("#heihachi_timeline .container-fluid").position().left +100;
                //put on right
                $(this).css({
                                    'left': 70,
                ...
                $("#heihachi_timeline .container-fluid").css({"position":"relative"});
                //put on left
                $(this).css({
                                    'left':0,
                                    'top':0,
            ...
            if($.timeline_left_position_top > $.timeline_right_position_top ){
                $("#heihachi_timeline .container-fluid").height($.timeline_left_position_top-40);
                $("#heihachi_timeline").height($.timeline_left_position_top+200);
            }else{
                $("#heihachi_timeline .container-fluid").height($.timeline_right_position_top-40);
                $("#heihachi_timeline").height($.timeline_right_position_top+200);
            }
            $(this).fadeIn();
        });
    });
    ...
    $("#heihachi_mobile_menu").css({"right":-1500});
    $("#mobile_menu").click(function(){
            $("#heihachi_mobile_menu").show();
            $("#heihachi_mobile_menu").animate({"right":0});
            return false;
    });
    $(window).on("load resize", function(){
            if($(window).width()>768){
    ...
    jQuery.fn.anchorAnimate = function(settings) {
        ...
        return this.each(function(){
            ...
            $(caller).click(function (event){
                ...
                var destination = $(elementClick).offset().top - $('#heihachi_banner_menu').outerHeight() ;
                $("#heihachi_mobile_menu").animate({"right":-1500});
                $("#heihachi_mobile_menu").fadeOut() ;
    ...
    $("#heihachi_mobile_menu a").anchorAnimate();
    //about
    $(document).scroll(function(){
        document_top = $(document).scrollTop();
        event_wapper_top = $("#heihachi_about").position().top - $('#heihachi_banner_menu').outerHeight();
    ...
    $(document).scroll(function(){
        document_top = $(document).scrollTop();
        event_wapper_top = $("#heihachi_skills").position().top - $('#heihachi_banner_menu').outerHeight();
        if(document_top<event_wapper_top){
            event_animate_num = event_wapper_top - document_top;
            event_animate_alpha = (1/event_wapper_top)*(document_top);
            $("#heihachi_skills .event_animate_left").css({'left': -event_animate_num,'opacity':event_animate_alpha});
            $("#heihachi_skills .event_animate_right").css({'left':event_animate_num,'opacity':event_animate_alpha});
        }else{
            $("#heihachi_skills .event_animate_left").css({'left': 0,'opacity':1});
            $("#heihachi_skills .event_animate_right").css({'left':0,'opacity':1});
        }
    });
});
//google map
function initialize(){
    ...
    myLatlng = new google.maps.LatLng(37.425691,-81.004401);
    //define style
    var styles = [
        {
            //set all color
    ...
    map = new google.maps.Map(document.getElementById('heihachi_contact_map'), mapOptions);
